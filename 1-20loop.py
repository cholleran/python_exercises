...
#Checks numbers from 20 to 10**10(in increments of 20) to find the lowest number that 'all' numbers in the list are evenly divisible by.
#When the program finds the lowest number evenly divisible, the 'break' command exits the loop.
